...
def plot_acr_bar(data: Dict[str, Dict[float, Dict[str, float]]], output_dir: str):
    ...
    output_acr_dir = os.path.join(output_dir)
    ...
    for system_name in system_names:
        ...
        for dt_value in sorted_dts:
            ...
            plot_fname = f'figure2_{safe_system_name}_dt{dt_value:.2f}_ACR'
            plot_path_svg = os.path.join(output_acr_dir, f'{plot_fname}.pdf')
...
def main():
    ...
    parser.add_argument("--root", type=str, default="../data", help="Root directory to search for ACR result .csv files (e.g., fixed_acr_dt0.1.csv).",)
    parser.add_argument("--output", type=str, default="../results", help="Directory to save the generated plots",)
