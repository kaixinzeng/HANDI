...
def main():
    ...
    for n, x0 in enumerate(tqdm(initial_conditions)):
        ...
        # true_equation = parse_and_prepare_equations(true_equation_file, dim)
        # true_model = create_true_model(true_equation)
    ...
    csv_mse_all_points = f"{output_dir}/{system}_mse_dt{output_dt_label}.csv"
