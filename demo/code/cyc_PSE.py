...
dt = 0.9
dim = 'dy'
default_csv = f'../data/cyc_train{int(dt*100)}_{dim}.csv'

@click.command()
@click.option("--experiment_name", default="cyc_pse", type=str, help="experiment_name")
@click.option("--yaml_file", default=f"cyc_{int(dt*100)}_{dim}_result.yaml", type=str, help="experiment_name")
