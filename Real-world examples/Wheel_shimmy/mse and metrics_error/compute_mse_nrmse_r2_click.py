...
def parse_arguments():
    ...
    parser.add_argument("--true_data_file",type=str, default="wheel/wheel_shimmy_train_dt_0.095.npy")
    parser.add_argument("--system", type=str, default="wheel", help="System name for output csv, e.g., NI")
    parser.add_argument("--dt", type=float,default=0.095, help="Time step of the trained data")
    parser.add_argument("--original_dt", type=float, default=0.005, help="Time step of the original data")
    parser.add_argument("--path_edmd", type=str, default="wheel/results/EDMD/dt{dt}/equations.txt")
    parser.add_argument("--path_sindy", type=str,default="wheel/results/SINDy/sindy_equation_dt{dt}.txt")
    parser.add_argument("--path_handi", type=str,default="wheel/results/HANDI/dt_{dt}/best_equations_by_mse_dt{dt}.txt")
    parser.add_argument("--path_pse", type=str,default="wheel/results/PSE/{dt}+4/final_ode_system_from_psrn.txt")
    parser.add_argument("--path_gedmd", type=str,default="wheel/results/gEDMD/gedmd_dt{dt}/best_equations.txt")
    parser.add_argument("--path_wsindy", type=str,default="wheel/results/WSINDy/dt{dt}/tune_best_equations.txt")
    parser.add_argument("--path_sr3", type=str,default="wheel/results/SR3/wheel_dt{dt}/sindy_sr3_equations.txt")
    parser.add_argument("--mse_steps", nargs='*',default=[None], help="Steps for MSE slicing, None means full length")
    parser.add_argument("--output_dir", type=str,default="nrmse_mse_r2/wheel/results/test")
