...
def main():
    ...
    # data & dictionary
    p.add_argument("--data", type=str, default="wheel_shimmy_train_downsampled_5.npy", help="path to npy array of shape (N,T,d)")
    p.add_argument("--dt", type=float, default=0.025)
    p.add_argument("--polyorder", type=int, default=4)  # 4-14

    # model
    p.add_argument("--g_dim", type=int, default=51)  # 51
    ...
    p.add_argument("--outdir", type=str, default="./edmd_runs1")
    ...
    # lightning runtime
    p.add_argument("--devices", type=int, default=1, help="Number of GPUs; >1 enables DDP (trial/final training must be 4)")
    ...
    p.add_argument("--hp_json", type=str, default="", help="JSON dict to override hyperparameters for this training (kept for compatibility)")
    p.add_argument("--top_r", type=int, default=4,
               help="Total number of coefficients to keep (across all states) when evaluating equation IVP, <=0 means no pruning")
