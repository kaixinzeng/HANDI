...
def export_artifacts(module, args, val_loader=None, outdir=None):
    ...
    if getattr(args, "true_coeff_json", ""):
        try:
            ...
            print(f"[NRMSE WARN] Failed to compute with true_coeff_json: {e}")
    ...
    torch.save({
        ...
        "names": module.names,
        "K_mono": K_mono,
        "R_mono2Q": module.R_mono2Q.cpu(),
        "Rinv_Q2mono": module.Rinv_Q2mono.cpu(),
        "K_aug_Q": module.K_aug_Q.cpu()
...
def main():
    ...
    # data & dictionary
    p.add_argument("--data", type=str, default="processed_trajectories_4D_subset.npy", help="path to npy array of shape (N,T,d)")
    ...
    p.add_argument("--outdir", type=str, default="./video_runs_4D_4_02")
