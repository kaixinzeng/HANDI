...
def main():
    ...
    # data & dictionary
    p.add_argument("--data", type=str, default="id6_downsample_45.npy", help="path to npy array of shape (N,T,d)")
    p.add_argument("--dt", type=float, default=2.25)
    p.add_argument("--polyorder", type=int, default=2)  # 4-14

    # model
    p.add_argument("--g_dim", type=int, default=60)  #4-51
    ...
    p.add_argument("--rollout_B", type=int, default=1)
    ...
    p.add_argument("--outdir", type=str, default="./result")
    ...
    p.add_argument("--top_r", type=int, default=4,
               help="Total number of coefficients to keep during equation IVP evaluation (across all states), <=0 means no clipping)")
