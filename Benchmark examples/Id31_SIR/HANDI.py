...
def main():
    ...
    # data & dictionary
    p.add_argument("--data", type=str, default="id31_downsample_6.npy", help="path to npy array of shape (N,T,d)")
    p.add_argument("--dt", type=float, default=0.30)
    p.add_argument("--polyorder", type=int, default=2)

    # model
    p.add_argument("--g_dim", type=int, default=60)
    ...
    p.add_argument("--rollout_B", type=int, default=8)
    ...
    p.add_argument("--outdir", type=str, default="./poly2_run1")
