...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="id39.npy", help="Input file path (.npy or .csv)")
    parser.add_argument("--output", type=str, default="id39_downsample_6.npy", help="Output file path")
