...
def main():
    ...
    # data & dictionary
    p.add_argument("--data", type=str, default="id39_downsample_6.npy", help="path to npy array of shape (N,T,d)")
    ...
    p.add_argument("--rollout_B", type=int, default=24)
    ...
    p.add_argument("--outdir", type=str, default="./poly3_run1")
    p.add_argument("--true_coeff_json", type=str,
                   default="",
                   help="Ground truth monomial coefficient matrix JSON string; empty for no NRMSE")
    ...
    p.add_argument("--tune_save_trials", type=int, default=0, help="Save each trial to tuning_dt.../trial_xxxx (1=yes, 0=no)")
    p.add_argument("--hp_json", type=str, default="", help="JSON dict to override hyperparameters")
    p.add_argument("--top_r", type=int, default=4,
               help="Number of top coefficients to keep for IVP evaluation; <=0 for no pruning")
