...
def parse_arguments():
    ...
    parser.add_argument("--system", type=str, default="id9", help="System name for output csv, e.g., NI")
    parser.add_argument("--noise", type=str, default="0%", help="Noise level directory name, e.g., 0%, 0.125%")
    parser.add_argument("--init_conditions_file", type=str, default="test_benchmark/results/true/id9.npy",help="path to true system equation file")
    parser.add_argument("--true_equation", type=str, default="test_benchmark/results/true/ground_truth_equations_id9.txt",help="path to true system equation file")
    parser.add_argument("--path_edmd", type=str, default="test_benchmark/results/{system}/edmd/{noise}/2+1/equations.txt")
    parser.add_argument("--path_sindy", type=str,default="test_benchmark/results/{system}/SINDy/{noise}/2+1/sindy_equation_best_2+1_stride1.txt")
    parser.add_argument("--path_handi", type=str,default="test_benchmark/results/{system}/HANDI/{noise}/best_equations_dt2.000.txt")
    parser.add_argument("--path_pse", type=str,default="test_benchmark/results/{system}/pse/{noise}/2+1/final_ode_system_from_psrn.txt")
    parser.add_argument("--path_gedmd", type=str,default="test_benchmark/results/{system}/gedmd/{noise}/2+1/equations.txt")
    ...
    parser.add_argument('--dt', type=float, default=2, help='Time step for downsampling/evaluation (dt).')
    ...
    parser.add_argument('--x_range_max', type=float, default=1.0, help='Maximum value for initial condition range.')
    ...
    parser.add_argument('--degree', type=int, default=1, help='Polynomial degree for feature library.')
    ...
    parser.add_argument('--output_dir', type=str, default='test_benchmark/test/id9', help='Base directory for saving output CSV files.')
