...
def parse_arguments():
    ...
    parser.add_argument('--system', type=str, default='duff', choices=['fixed', 'linear', 'vdp', 'cyc'],
                        help='Select system dynamics for ground truth simulation.')
    parser.add_argument("--true_equation", type=str, default="results/true_equation.txt",
                        help="path to true system equation file")
    parser.add_argument("--path_edmd", type=str,
                        default="results/EDMD_results/EDMD_equation_poly_10_polysysid_3_dt_{dt}.txt")
    parser.add_argument("--path_sindy", type=str, default="results/sindy_results/SINDY_equation_poly_3_dt_{dt}.txt")
    parser.add_argument("--path_handi", type=str,
                        default="results/HANDI_results/edmd_runs_{dt}_withL/best_equations_dt{dt}.txt")
    parser.add_argument("--path_pse", type=str,
                        default="results/PSE_results/duff_train{dt}/final_ode_system_from_psrn.txt")
    parser.add_argument("--path_gedmd", type=str, default="results/gedmd/gedmd_dt{dt}/best_equations.txt")
    parser.add_argument("--path_wsindy", type=str, default="results/WSINDy_results/duffing{dt}/tune_best_equations.txt")
    parser.add_argument("--path_sr3", type=str, default="results/sindysr3_results/duffing{dt}/tune_best_equations.txt")
    ...
    parser.add_argument('--output_dir', type=str, default='attractor_consistnecy',
