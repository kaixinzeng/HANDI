...
def main():
    ...
    # data & dictionary
    p.add_argument("--data", type=str, default="fixed_point_50.npy", help="path to npy array of shape (N,T,d)")
    ...
    # training
    p.add_argument("--epochs_A", type=int, default=0)
    ...
    p.add_argument("--outdir", type=str, default="ablationA/edmd_runs_dt0.5")
