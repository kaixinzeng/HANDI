...
if __name__ == "__main__":
    ...
    try:
        ...
        idx_x1_cubed_for_dx2 = xbasis_name_example.index('x(1)*x(1)*x(1)')
        
        weights_true_example[idx_x2_for_dx2, 1] = -lambda_val
        weights_true_example[idx_x1_for_dx2, 1] = -alpha
        weights_true_example[idx_x1_cubed_for_dx2, 1] = -beta
    ...
    default_params = {
        ...
        'deltaT': 0.01,
        'T_sample': np.array([10, 20, 30, 40]),
        'polyorder': polyorder_example,
        'Nbasis_for_sysid': N_basis_example,
        'save_dir': 'results/EDMD_results', # Updated save directory
        'data_filename_pattern': './data/duff_train{}_Nsim10.npy' # NEW: Data filename pattern
    }
