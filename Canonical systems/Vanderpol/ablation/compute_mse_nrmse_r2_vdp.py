...
def parse_arguments():
    ...
    parser.add_argument('--system', type=str, default='vdp',choices=['fixed', 'linear', 'vdp','cyc','duffing'],help='Select system dynamics for ground truth simulation.')
    ...
    parser.add_argument('--output_dir', type=str, default='ablation_study/mse_results/vdp', help='Base directory for saving output CSV files.')
