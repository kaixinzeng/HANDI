...
def main():
    ...
    method_names_nrmse = ['SINDy', 'HANDI', 'PSE', 'gEDMD', 'wSINDy', 'SR3']
    method_names_mse = ['SINDy', 'HANDI', 'PSE', 'gEDMD', 'wSINDy', 'SR3']
...
def parse_arguments():
    ...
    parser.add_argument("--true_equation", type=str, default="results/true_equation.txt",help="path to true system equation file")
    parser.add_argument("--path_edmd", type=str, default="results/edmd/EDMD_equation_poly_10_polysysid_5_dt_{dt}.txt")
    parser.add_argument("--path_sindy", type=str,default="results/sindy/SINDY_equation_poly_5_dt_{dt}.txt")
    parser.add_argument("--path_handi", type=str,default="results/HANDI/edmd_runs_vdp{dt}/best_equations_dt{dt}.txt")
    parser.add_argument("--path_pse", type=str,default="results/PSE/equation_{dt}_new.txt")
    parser.add_argument("--path_gedmd", type=str,default="results/gedmd/gedmd_dt{dt}/best_equations.txt")
    parser.add_argument("--path_wsindy", type=str,default="results/wsindy/vdp{dt}/tune_best_equations.txt")
    parser.add_argument("--path_sr3", type=str,default="results/sr3/vdp{dt}/tune_best_equations.txt")
