...
def parse_arguments():
    ...
    parser.add_argument('--system', type=str, default='vdp',choices=['fixed', 'linear', 'vdp','cyc','duffing','m1k16c8'],help='Select system dynamics for ground truth simulation.')
    parser.add_argument("--true_equation", type=str, default="vdp/results/true_equation.txt",help="path to true system equation file")
    parser.add_argument("--path_edmd", type=str, default="vdp/results/edmd/EDMD_equation_poly_10_polysysid_5_dt_{dt}.txt")
    parser.add_argument("--path_sindy", type=str,default="vdp/results/sindy/SINDY_equation_poly_5_dt_{dt}.txt")
    parser.add_argument("--path_handi", type=str,default="vdp/results/HANDI/edmd_runs_vdp{dt}/best_equations_dt{dt}.txt")
    parser.add_argument("--path_pse", type=str,default="vdp/results/PSE/equation_{dt}_new.txt")
    parser.add_argument("--path_gedmd", type=str,default="vdp/results/gedmd/gedmd_dt{dt}/best_equations.txt")
    parser.add_argument("--path_wsindy", type=str,default="vdp/results/wsindy/vdp{dt}/tune_best_equations.txt")
    parser.add_argument("--path_sr3", type=str,default="vdp/results/sr3/vdp{dt}/tune_best_equations.txt")
    ...
    parser.add_argument('--output_dir', type=str, default='nrmse_mse_r2/vdp/vdp_0.5', help='Base directory for saving output CSV files.')
