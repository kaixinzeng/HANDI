...
def main():
    ...
    filename_nrmse = [
        ...
        args.path_pse.format(dt=f"{filename_dt:.1f}"),
...
def parse_arguments():
    ...
    parser.add_argument("--true_equation", type=str, default="cyc/results/true_equation.txt",help="path to true system equation file")
    parser.add_argument("--path_edmd", type=str, default="cyc/results/edmd/EDMD_equation_poly_10_polysysid_5_dt_{dt}.txt")
    parser.add_argument("--path_sindy", type=str,default="cyc/results/sindy/SINDY_equation_poly_5_dt_{dt}.txt")
    parser.add_argument("--path_handi", type=str,default="cyc/results/HANDI/edmd_runs_cyc{dt}/best_equations_dt{dt}.txt")
    parser.add_argument("--path_pse", type=str,default="cyc/results/PSE/equation_{dt}_new.txt")
    parser.add_argument("--path_gedmd", type=str,default="cyc/results/gedmd/gedmd_dt{dt}/best_equations.txt")
    parser.add_argument("--path_wsindy", type=str,default="cyc/results/wsindy/cyc{dt}/tune_best_equations.txt")
    parser.add_argument("--path_sr3", type=str,default="cyc/results/sr3/cyc{dt}/tune_best_equations.txt")
    ...
    parser.add_argument('--output_dir', type=str, default='Attractor_consistency/cyc/cyc1.0', help='Base directory for saving output CSV files.')
