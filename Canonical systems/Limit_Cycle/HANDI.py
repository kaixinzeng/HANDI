...
def main():
    ...
    # data & dictionary
    p.add_argument("--data", type=str, default="data/cyc_train90.npy", help="path to npy array of shape (N,T,d)")
    p.add_argument("--dt", type=float, default=0.9) 
    p.add_argument("--polyorder", type=int, default=5)

    # model
    p.add_argument("--g_dim", type=int, default=45) 
    ...
    p.add_argument("--outdir", type=str, default="EDMD_result/cyc/poly_5/A/edmd_runs_cyc90")  ##modyfy!!
