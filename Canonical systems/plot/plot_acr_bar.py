...
def plot_acr_bar(data: Dict[str, Dict[float, Dict[str, float]]], output_dir: str):
    ...
    output_acr_dir = os.path.join(output_dir, 'ACR_Charts_Per_Dt')
...
def main():
    ...
    parser.add_argument("--root", type=str, default="./Attractor_consistency", help="Root directory to search for ACR result .csv files (e.g., fixed_acr_dt0.1.csv).",)
    parser.add_argument("--output", type=str, default="./Attractor_consistency/plots_bar", help="Directory to save the generated plots",)
