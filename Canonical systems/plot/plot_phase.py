...
plt.tight_layout()
# plt.savefig(f'P3_1127/plot_cyc/1212/phase_cyc_dt{dt}_x1x2_label.svg', format="svg", bbox_inches="tight")
plt.savefig(f'P3_1127/plot_cyc/1212/phase_cyc_dt{dt}_x1x2_label.pdf', format="pdf", bbox_inches="tight")